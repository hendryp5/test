        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="login-card card-block">
                    <form class="md-float-material" action="ceklogin.php" method="post">
                        ...
                        <div class="col-sm-12 col-xs-12 text-center">
                            <span class="text-muted">Belum terdaftar sebagai member?</span>
                            <a href="register.php" class="f-w-600 p-l-5">Daftar Disini</a>
                        </div>
