...
<div id="page-wrapper">
            <div class="container-fluid">
              ...
              <?php if($data['skm']!='') { ?>
              <div>
                            <?php $hoy = substr($data['skm'], -3); if($hoy=='pdf') { ?>
                                <a href="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['skm']; ?>"><img src="img/pdf.png" style="width: 150px"></a>
                            <?php } else { ?> 
                                <img src="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['skm']; ?>" style="width: 180px">
                            <?php } ?>
                           ...
                           <input name="tipe" type="hidden" id="hiddenField" value="Ganti_skm" />
