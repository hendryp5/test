            ...
            <div class="container-fluid">
              ...
              <div>
                            <?php $hoy = substr($data['kk'], -3); if($hoy=='pdf') { ?>
                                <a href="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['kk']; ?>"><img src="img/pdf.png" style="width: 150px"></a>
                            <?php } else { ?> 
                                <img src="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['kk']; ?>" style="width: 180px">
                            <?php } ?>
                           ...
                           <input name="tipe" type="hidden" id="hiddenField" value="Ganti_kk" />
