...
<div id="page-wrapper">
            <div class="container-fluid">
              ...
              <div>
                            <?php $hoy = substr($data['sertifikat'], -3); if($hoy=='pdf') { ?>
                                <a href="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['sertifikat']; ?>"><img src="img/pdf.png" style="width: 150px"></a>
                            <?php } else { ?> 
                                <img src="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['sertifikat']; ?>" style="width: 180px">
                            <?php } ?>
                           ...
                           <input name="tipe" type="hidden" id="hiddenField" value="Ganti_sertifikat" />
