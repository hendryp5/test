            ...
            <div class="container-fluid">
              ...
              <div>
                            <?php $hoy = substr($data['ijazah'], -3); if($hoy=='pdf') { ?>
                                <a href="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['ijazah']; ?>"><img src="img/pdf.png" style="width: 150px"></a>
                            <?php } else { ?> 
                                <img src="berkas/<?php echo $_SESSION['username']; ?>/<?php echo $data['ijazah']; ?>" style="width: 180px">
                            <?php } ?>
                           ...
                           <input name="tipe" type="hidden" id="hiddenField" value="Ganti_Ijazah" />
