...
<?php 
    ...
    $q1=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/2'");
    ...
    $q2=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/3'");
    ...
    $q3=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/4'");
    ...
    $q4=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/5' ");
    ...
    $q5=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/6' ");
    ...
    $q6=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/7' ");
    ...
    $q7=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/8' ");
    ...
    $q8=mysql_query("SELECT  count(if (jawab = 1, thkusionerdos.id_kuisioner,NULL)) as jum1, count(if (jawab = 2, thkusionerdos.id_kuisioner,NULL)) as jum2, count(if (jawab = 3, thkusionerdos.id_kuisioner,NULL)) as jum3, count(if (jawab = 4, thkusionerdos.id_kuisioner,NULL)) as jum4, count(if (jawab = 5, thkusionerdos.id_kuisioner,NULL)) as jum5, tkuisioner.pertanyaan  FROM thkusionerdos left join tkuisioner on thkusionerdos.id_kuisioner = tkuisioner.id_kuisioner  where tkuisioner.jenis_kuisioner = 'dosen' and thkusionerdos.nik = '120102069' and thkusionerdos.id_kelas = '14' and thkusionerdos.id_kuisioner = 'dosen/9' ");
